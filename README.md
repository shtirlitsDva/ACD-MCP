# ACD-MCP
** WARNING! ** This README has been written by Claude and is full of AI slop. This MCP works as I am using it everyday, but you cannot load it with a simple netload, unfortunately. To do that remove the NoCommands class, so Autocad can discover COMMANDMETHODs. I added this class so my special isolated ACL loader will work. And just use an agent to help you set this up for your system. But otherwise this works very well, any script can be sent to autocad/civil and executed at runtime.
